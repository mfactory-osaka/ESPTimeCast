...
#include "mfactoryfont.h" // Custom fon
        ...
        { // Current mode is Clock
          if (weatherAvailable && (strlen(openWeatherApiKey) == 32) && (strlen(openWeatherCity) > 0) && (strlen(openWeatherCountry) > 0))
          {
            ...
            { // Current mode is Weather
              ...
              { // Current mode is Weather Description
                ...
                if (oldMode == 3 && displayMode != 3)
                { // Exiting Countdown Mode
                  P.displayClear();
